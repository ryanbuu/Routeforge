    ...
    <div className="space-y-2">
      {entries.map(entry => (
        <div key={entry.key} className="rounded-lg border border-white/20 overflow-hidden">
          <div className="px-3 py-1.5 bg-white/20 text-xs font-semibold text-foreground/80 flex items-center gap-2">
            ...
            <button
              ...
              className={cn(
                ...
                resource === tab.key
                  ...
                  : 'bg-white/30 text-muted-foreground border-white/20 hover:bg-white/50'
              )}
            >
              {tab.label}
            </button>
                  ...
                  <div key={item.id}>
                    {showDateHeader && (
                      <div className="flex items-center gap-3 py-2 pl-[14px]">
                        <div className="h-[18px] w-[18px] rounded-full bg-white/60 border border-white/40 flex items-center justify-center">
                    ...
                    <div className="flex items-start gap-3 group pl-[14px]">
                      ...
                      {/* Card */}
                      <div className="flex-1 rounded-xl glass-subtle px-4 py-3 group-hover:bg-white/40 transition-all duration-200 mb-1">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <div className="flex items-center gap-1.5 text-sm">
                                ...
                                {desc.name && (
                                  <span className="bg-white/50 border border-white/30 rounded-md px-1.5 py-0.5 text-xs font-semibold text-foreground/80">
                                    {desc.name}
                                  </span>
                                )}
                              </div>
